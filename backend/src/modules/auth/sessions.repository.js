...
function createSessions(db) {
  return {
    create: ({ jti, username, kind, startedAt, expiresAt, ip }) => db.run(
      'INSERT INTO sessions (jti, username, kind, started_at, expires_at, ip) VALUES ($1, $2, $3, $4, $5, $6)',
      [jti, username, kind, startedAt, expiresAt, ip || null],
    ),
