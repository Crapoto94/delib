...
const HUB = [
  ...
  { displayName: 'HELENE BOURDELET', email: 'hbourdelet@ivry94.fr' }, { displayName: 'ELISABETH FRANCES', email: 'efrances@ivry94.fr' }, { displayName: 'JEROME FRANCES', email: 'jfrances@ivry94.fr' },
];
