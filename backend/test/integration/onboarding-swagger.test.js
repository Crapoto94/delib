...
describe('documentation Swagger (critère d\'acceptation n°7)', () => {
  ...
  it("les routes publiques sont explicitement déclarées sans sécurité, toutes les autres exigent le jeton", async () => {
    ...
    const publiques = ['POST /api/v1/elus-auth/code', 'POST /api/v1/elus-auth/connexion', 'POST /api/v1/elus-auth/invitation/{token}', 'POST /api/v1/elus-auth/oubli', 'POST /api/v1/elus-auth/oubli-sms', 'POST /api/v1/elus-auth/oubli-sms/code'];
    expect(open.filter((x) => !publiques.includes(x))).toEqual(['GET /api/status', 'GET /api/v1/calendrier/{fichier}', 'GET /api/v1/public/branding', 'GET /api/v1/public/organismes/{orgId}/logo', 'GET /api/v1/public/convocations/{token}', 'GET /api/v1/public/convocations/{token}/convocation.pdf', 'GET /api/v1/public/convocations/{token}/ordre-du-jour.pdf', 'GET /api/v1/public/convocations/{token}/pieces/{fichierId}', 'POST /api/v1/auth/login', 'POST /api/v1/auth/login-local', 'POST /api/v1/public/convocations/{token}/accuse', 'POST /api/v1/public/convocations/{token}/reponse'].sort());
