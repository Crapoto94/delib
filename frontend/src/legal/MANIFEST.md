...
> **Statut : v1.46 — validée le 2026-09-19 (v1.0), mise à jour au fil du développement (voir le journal, section 34).** Le développement démarre par le **lot 0** (voir `LOT0.md`) ; toute évolution du périmètre passe par ce manifeste (journal en section 34).
...
- **Mes actes** : page unique — tous les actes **non encore passés au conseil** qui me concernent, en deux vues : **par rubrique** (action attendue de moi, rédaction/validation de mon équipe, actes que j'ai validés et qui poursuivent leur circuit, actes **qui ne sont plus à mon étape** — encore en circuit chez un autre avec son **étape** affichée, ou circuit validé en attente de séance) ou **par conseil pressenti** (comme « Tous les actes ») ; **pastille « Inscrit au conseil »** et **fond vert** si le circuit est validé ET l'acte inscrit ; **retard distingué**. `GET /circuit/portefeuille`.
