...
const STEPS: Step[] = [
  ...
  { id: 'tableau-de-bord', badge: 'decouverte', titre: 'Votre tableau de bord', cible: 'nav-mes-actes', route: '/', texte: <>C’est votre page d’accueil : ce que <b>vous avez à faire aujourd’hui</b> (dossiers à valider, modifications demandées), vos dossiers en cours et les prochaines séances du conseil.</> },
  { id: 'dossiers', badge: 'redaction', titre: 'Un « dossier » = un acte à faire adopter', cible: 'nav-mes-actes', route: '/dossiers', texte: <>Une délibération (ou tout autre acte) s’appelle ici un <b>dossier</b>. Cette page liste <b>« Mes dossiers »</b> (ceux que vous rédigez), ceux que vous <b>suivez</b> et tous ceux que vous avez le droit de voir.</> },
