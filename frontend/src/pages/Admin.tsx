...
export default function Admin() {
  ...
  const tabs = [['identite', 'Identité & logo'], ['utilisateurs', 'Utilisateurs & rôles'], ['titulaires', 'Titulaires & droits'], ['circuits', 'Circuits'], ['gabarits', 'Gabarits PDF'], ['notifications', 'Notifications & relances'], ['ia', 'Assistant IA'], ['elus', 'Élus'], ['espace-elus', 'Espace élus'], ['tdt', 'Télétransmission (TDT)'], ['ged', 'GED (Alfresco)'], ...(isAdmin ? [['champs', 'Champs personnalisés'], ['recherche', 'Recherche'], ['configuration', 'Export / import']] : []), ['calendrier', 'Jours fériés'], ...(me?.isPlatformAdmin ? [['collectivites', 'Collectivités'], ['sauvegarde', 'Sauvegarde']] : [])];
  return (
    <div>
